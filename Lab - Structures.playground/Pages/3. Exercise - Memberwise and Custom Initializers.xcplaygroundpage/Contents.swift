...
let favoriteBook = Book(title: "A long walk to water", author: "Linda Sue Park", pages: 128, price: 6.78)
print(favoriteBook)
/*:
...
let mac = Laptop(yearPurchased: 2018)
print(mac)

let HP = Laptop(yearPurchased: 2019)
print(HP)
/*:
...
var someonesHeight = Height(heightInInches: 65, heightInCentimeters: 65)
...
var myHeight = Height(heightInInches: 66, heightInCentimeters: 66)
print(myHeight)
/*:
